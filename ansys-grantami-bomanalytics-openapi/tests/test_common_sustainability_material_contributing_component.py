...
def test_CommonSustainabilityMaterialContributingComponent():
    """Test CommonSustainabilityMaterialContributingComponent"""

    model = generate_model(CommonSustainabilityMaterialContributingComponent)
    assert model
