...
def test_CommonSustainabilityPartWithSustainability():
    """Test CommonSustainabilityPartWithSustainability"""

    model = generate_model(CommonSustainabilityPartWithSustainability)
    assert model
