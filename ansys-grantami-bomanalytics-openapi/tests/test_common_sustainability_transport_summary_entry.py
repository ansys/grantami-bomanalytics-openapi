...
def test_CommonSustainabilityTransportSummaryEntry():
    """Test CommonSustainabilityTransportSummaryEntry"""

    model = generate_model(CommonSustainabilityTransportSummaryEntry)
    assert model
