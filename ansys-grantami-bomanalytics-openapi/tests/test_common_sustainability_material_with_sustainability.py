...
def test_CommonSustainabilityMaterialWithSustainability():
    """Test CommonSustainabilityMaterialWithSustainability"""

    model = generate_model(CommonSustainabilityMaterialWithSustainability)
    assert model
