...
def test_CommonSustainabilityTransportWithSustainability():
    """Test CommonSustainabilityTransportWithSustainability"""

    model = generate_model(CommonSustainabilityTransportWithSustainability)
    assert model
