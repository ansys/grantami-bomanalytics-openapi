    ...
    def test_post_impactedsubstances_bom1711(self, api_client):
        ...
        with requests_mock.Mocker() as m:
            m.post(
                ...
                json=get_example(GetImpactedSubstancesForBom1711Response),
            )
    ...
    def test_post_impactedsubstances_materials(self, api_client):
        ...
        with requests_mock.Mocker() as m:
            m.post(
                ...
                json=get_example(GetImpactedSubstancesForMaterialsResponse),
            )
    ...
    def test_post_impactedsubstances_parts(self, api_client):
        ...
        with requests_mock.Mocker() as m:
            m.post(
                ...
                json=get_example(GetImpactedSubstancesForPartsResponse),
            )
    ...
    def test_post_impactedsubstances_specifications(self, api_client):
        ...
        with requests_mock.Mocker() as m:
            m.post(
                ...
                json=get_example(GetImpactedSubstancesForSpecificationsResponse),
            )
