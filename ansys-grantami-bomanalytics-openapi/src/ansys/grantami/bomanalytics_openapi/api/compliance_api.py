...
class ComplianceApi(ApiBase):
    ...
    def _post_compliance_bom1711_with_http_info(self, body: "GetComplianceForBom1711Request", **kwargs: Any) -> Any:
    ...
    def post_compliance_bom2301(self, *, body: "GetComplianceForBom2301Request") -> "GetComplianceForBom2301Response":
        """Determine the compliance of a BoM in the context of specified indicators
    ...
    def _post_compliance_bom2301_with_http_info(self, body: "GetComplianceForBom2301Request", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method post_compliance_bom2301")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "body" is set
        if "body" not in params or params["body"] is None:
            raise ValueError("Missing the required parameter 'body' when calling 'post_compliance_bom2301'")
    ...
    def _post_compliance_materials_with_http_info(self, body: "GetComplianceForMaterialsRequest", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]
    ...
    def _post_compliance_parts_with_http_info(self, body: "GetComplianceForPartsRequest", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]
    ...
    def _post_compliance_specifications_with_http_info(self, body: "GetComplianceForSpecificationsRequest", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]
    ...
    def _post_compliance_substances_with_http_info(self, body: "GetComplianceForSubstancesRequest", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]
