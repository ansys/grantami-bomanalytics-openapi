...
class SustainabilityApi(ApiBase):
    ...
    def post_sustainability_bom2301(self, *, body: "GetSustainabilityForBom2301Request") -> "GetSustainabilityForBom2301Response":
    ...
    def _post_sustainability_bom2301_with_http_info(self, body: "GetSustainabilityForBom2301Request", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method post_sustainability_bom2301")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "body" is set
        if "body" not in params or params["body"] is None:
            raise ValueError("Missing the required parameter 'body' when calling 'post_sustainability_bom2301'")
    ...
    def post_sustainabilitysummary_bom2301(self, *, body: "GetSustainabilitySummaryForBom2301Request") -> "GetSustainabilitySummaryForBom2301Response":
        ...
        """
        data = self._post_sustainabilitysummary_bom2301_with_http_info(body, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _post_sustainabilitysummary_bom2301_with_http_info(self, body: "GetSustainabilitySummaryForBom2301Request", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method post_sustainabilitysummary_bom2301")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "body" is set
        if "body" not in params or params["body"] is None:
            raise ValueError("Missing the required parameter 'body' when calling 'post_sustainabilitysummary_bom2301'")
        ...
        return self.api_client.call_api(
            "/sustainability-summary/bom2301", "POST",
            path_params,
            query_params,
            header_params,
            body=body_params,
