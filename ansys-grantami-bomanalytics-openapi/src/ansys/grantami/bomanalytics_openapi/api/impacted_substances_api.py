...
class ImpactedSubstancesApi(ApiBase):
    ...
    def post_impactedsubstances_bom1711(self, body, **kwargs):  # noqa: E501
        ...
        (data) = self.post_impactedsubstances_bom1711_with_http_info(
            body, **kwargs
        )  # noqa: E501
        return data

    def post_impactedsubstances_bom1711_with_http_info(
        self, body, **kwargs
    ):  # noqa: E501
        """Get the impacted substances for a Bill of Materials  # noqa: E501
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '{}' to method post_impactedsubstances_bom1711".format(
                        key
                    )
                )
            params[key] = val
    ...
    def post_impactedsubstances_materials(self, body, **kwargs):  # noqa: E501
        ...
        """
        kwargs["_return_http_data_only"] = True
        (data) = self.post_impactedsubstances_materials_with_http_info(
            body, **kwargs
        )  # noqa: E501
        return data

    def post_impactedsubstances_materials_with_http_info(
        self, body, **kwargs
    ):  # noqa: E501
        """Get the impacted substances for materials  # noqa: E501
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '{}' to method post_impactedsubstances_materials".format(
                        key
                    )
                )
            params[key] = val
    ...
    def post_impactedsubstances_parts(self, body, **kwargs):  # noqa: E501
        ...
        """
        kwargs["_return_http_data_only"] = True
        (data) = self.post_impactedsubstances_parts_with_http_info(
            body, **kwargs
        )  # noqa: E501
        return data

    def post_impactedsubstances_parts_with_http_info(
        self, body, **kwargs
    ):  # noqa: E501
        """Get the impacted substances for parts  # noqa: E501
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '{}' to method post_impactedsubstances_parts".format(
                        key
                    )
                )
            params[key] = val
    ...
    def post_impactedsubstances_specifications(self, body, **kwargs):  # noqa: E501
        ...
        """
        kwargs["_return_http_data_only"] = True
        (data) = self.post_impactedsubstances_specifications_with_http_info(
            body, **kwargs
        )  # noqa: E501
        return data

    def post_impactedsubstances_specifications_with_http_info(
        self, body, **kwargs
    ):  # noqa: E501
        """Get the impacted substances for specifications  # noqa: E501
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '{}' to method post_impactedsubstances_specifications".format(
                        key
                    )
                )
            params[key] = val
