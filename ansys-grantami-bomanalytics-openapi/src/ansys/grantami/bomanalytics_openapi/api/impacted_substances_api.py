...
import re  # noqa: F401
from typing import TYPE_CHECKING, Any, Dict, BinaryIO, List, Optional, Union  # noqa: F401
from . import ApiBase
...
class ImpactedSubstancesApi(ApiBase):
    ...
    def post_impactedsubstances_bom1711(self, *, body: "GetImpactedSubstancesForBom1711Request") -> "GetImpactedSubstancesForBom1711Response":
        ...
        """
        data = self._post_impactedsubstances_bom1711_with_http_info(body, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _post_impactedsubstances_bom1711_with_http_info(self, body: "GetImpactedSubstancesForBom1711Request", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method post_impactedsubstances_bom1711")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "body" is set
        if "body" not in params or params["body"] is None:
            raise ValueError("Missing the required parameter 'body' when calling 'post_impactedsubstances_bom1711'")
    ...
    def post_impactedsubstances_bom2301(self, *, body: "GetImpactedSubstancesForBom2301Request") -> "GetImpactedSubstancesForBom2301Response":
        """Get the impacted substances for a Bill of Materials
        ...
        """
        data = self._post_impactedsubstances_bom2301_with_http_info(body, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _post_impactedsubstances_bom2301_with_http_info(self, body: "GetImpactedSubstancesForBom2301Request", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method post_impactedsubstances_bom2301")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "body" is set
        if "body" not in params or params["body"] is None:
            raise ValueError("Missing the required parameter 'body' when calling 'post_impactedsubstances_bom2301'")
        ...
        return self.api_client.call_api(
            "/impacted-substances/bom2301", "POST",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_impactedsubstances_materials(self, *, body: "GetImpactedSubstancesForMaterialsRequest") -> "GetImpactedSubstancesForMaterialsResponse":
        ...
        """
        data = self._post_impactedsubstances_materials_with_http_info(body, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _post_impactedsubstances_materials_with_http_info(self, body: "GetImpactedSubstancesForMaterialsRequest", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method post_impactedsubstances_materials")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "body" is set
        if "body" not in params or params["body"] is None:
            raise ValueError("Missing the required parameter 'body' when calling 'post_impactedsubstances_materials'")
    ...
    def post_impactedsubstances_parts(self, *, body: "GetImpactedSubstancesForPartsRequest") -> "GetImpactedSubstancesForPartsResponse":
    ...
    def _post_impactedsubstances_parts_with_http_info(self, body: "GetImpactedSubstancesForPartsRequest", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method post_impactedsubstances_parts")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "body" is set
        if "body" not in params or params["body"] is None:
            raise ValueError("Missing the required parameter 'body' when calling 'post_impactedsubstances_parts'")
    ...
    def post_impactedsubstances_specifications(self, *, body: "GetImpactedSubstancesForSpecificationsRequest") -> "GetImpactedSubstancesForSpecificationsResponse":
        ...
        """
        data = self._post_impactedsubstances_specifications_with_http_info(body, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _post_impactedsubstances_specifications_with_http_info(self, body: "GetImpactedSubstancesForSpecificationsRequest", **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method post_impactedsubstances_specifications")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "body" is set
        if "body" not in params or params["body"] is None:
            raise ValueError("Missing the required parameter 'body' when calling 'post_impactedsubstances_specifications'")
