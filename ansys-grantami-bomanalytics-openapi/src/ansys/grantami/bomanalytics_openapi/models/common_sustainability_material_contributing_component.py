...
class CommonSustainabilityMaterialContributingComponent(ModelBase):
    ...
    def __init__(self, *, component_name: "Union[str, Unset_Type]" = Unset, component_part_number: "Union[str, Unset_Type]" = Unset, material_mass_before_processing: "Union[CommonValueWithUnit, Unset_Type]" = Unset, record_reference: "Union[CommonPartReference, Unset_Type]" = Unset,) -> None:
    ...
    def material_mass_before_processing(self, material_mass_before_processing: "Union[CommonValueWithUnit, Unset_Type]") -> None:
        ...
        if material_mass_before_processing is None:
            raise ValueError("Invalid value for 'material_mass_before_processing', must not be 'None'")
