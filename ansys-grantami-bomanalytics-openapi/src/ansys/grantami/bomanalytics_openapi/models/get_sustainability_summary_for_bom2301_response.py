...
class GetSustainabilitySummaryForBom2301Response(ModelBase):
    ...
    def __init__(self, *, log_messages: "Union[List[CommonLogEntry], Unset_Type]" = Unset, material_summary: "Union[CommonSustainabilityMaterialSummary, Unset_Type]" = Unset, process_summary: "Union[CommonSustainabilityProcessSummary, Unset_Type]" = Unset, transport_summary: "Union[CommonSustainabilityTransportSummary, Unset_Type]" = Unset,) -> None:
    ...
    def material_summary(self, material_summary: "Union[CommonSustainabilityMaterialSummary, Unset_Type]") -> None:
    ...
    def process_summary(self, process_summary: "Union[CommonSustainabilityProcessSummary, Unset_Type]") -> None:
    ...
    def transport_summary(self, transport_summary: "Union[CommonSustainabilityTransportSummary, Unset_Type]") -> None:
