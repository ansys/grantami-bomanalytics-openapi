...
class CommonSustainabilityMaterialSummaryEntry(ModelBase):
    ...
    def __init__(self, *, climate_change: "Union[CommonValueWithUnit, Unset_Type]" = Unset, climate_change_percentage: "Union[float, Unset_Type]" = Unset, embodied_energy: "Union[CommonValueWithUnit, Unset_Type]" = Unset, embodied_energy_percentage: "Union[float, Unset_Type]" = Unset, identity: "Union[str, Unset_Type]" = Unset, largest_contributors: "Union[List[CommonSustainabilityMaterialContributingComponent], Unset_Type]" = Unset, mass_after_processing: "Union[CommonValueWithUnit, Unset_Type]" = Unset, mass_before_processing: "Union[CommonValueWithUnit, Unset_Type]" = Unset, record_reference: "Union[CommonMaterialReference, Unset_Type]" = Unset,) -> None:
        ...
        self._largest_contributors: Union[List[CommonSustainabilityMaterialContributingComponent], Unset_Type] = Unset
    ...
    def record_reference(self, record_reference: "Union[CommonMaterialReference, Unset_Type]") -> None:
    ...
    def embodied_energy_percentage(self, embodied_energy_percentage: "Union[float, Unset_Type]") -> None:
    ...
    def climate_change_percentage(self, climate_change_percentage: "Union[float, Unset_Type]") -> None:
    ...
    def mass_before_processing(self, mass_before_processing: "Union[CommonValueWithUnit, Unset_Type]") -> None:
    ...
    def mass_after_processing(self, mass_after_processing: "Union[CommonValueWithUnit, Unset_Type]") -> None:
    ...
    @property
    def largest_contributors(self) -> "Union[List[CommonSustainabilityMaterialContributingComponent], Unset_Type]":
    ...
    def largest_contributors(self, largest_contributors: "Union[List[CommonSustainabilityMaterialContributingComponent], Unset_Type]") -> None:
