...
class GetComplianceForSpecificationsResponse(ModelBase):
    ...
    def __init__(self, *, log_messages: "Union[List[CommonLogEntry], Unset_Type]" = Unset, specifications: "Union[List[CommonSpecificationWithCompliance], Unset_Type]" = Unset,) -> None:
