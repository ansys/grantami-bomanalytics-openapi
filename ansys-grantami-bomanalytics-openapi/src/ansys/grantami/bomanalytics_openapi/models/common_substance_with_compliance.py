...
class CommonSubstanceWithCompliance(ModelBase):
    ...
    def __init__(self, *, external_identity: "Union[str, Unset_Type]" = Unset, id: "Union[str, Unset_Type]" = Unset, indicators: "Union[List[CommonIndicatorResult], Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset, percentage_amount: "Union[float, None, Unset_Type]" = Unset, reference_type: "Union[str, Unset_Type]" = Unset, reference_value: "Union[str, Unset_Type]" = Unset,) -> None:
