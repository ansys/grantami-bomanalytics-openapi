...
class CommonSustainabilityTransportSummary(ModelBase):
    ...
    @property
    def summary(self) -> "list[CommonSustainabilityTransportSummaryEntry]":
        """Gets the summary of this CommonSustainabilityTransportSummary.

        Returns
        -------
        list[CommonSustainabilityTransportSummaryEntry]
    ...
    @summary.setter
    def summary(
        self, summary: "list[CommonSustainabilityTransportSummaryEntry]"
    ) -> None:
    ...
    def to_dict(self) -> Dict:
        ...
        for attr in self.swagger_types.keys():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CommonSustainabilityTransportSummary, dict):
