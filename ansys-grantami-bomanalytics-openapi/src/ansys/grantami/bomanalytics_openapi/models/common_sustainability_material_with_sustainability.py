...
class CommonSustainabilityMaterialWithSustainability(ModelBase):
    ...
    def __init__(self, *, biodegradable: "Union[bool, None, Unset_Type]" = Unset, climate_change: "Union[CommonValueWithUnit, Unset_Type]" = Unset, embodied_energy: "Union[CommonValueWithUnit, Unset_Type]" = Unset, external_identity: "Union[str, Unset_Type]" = Unset, functional_recycle: "Union[bool, None, Unset_Type]" = Unset, id: "Union[str, Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset, processes: "Union[List[CommonSustainabilityProcessWithSustainability], Unset_Type]" = Unset, recyclable: "Union[bool, None, Unset_Type]" = Unset, reference_type: "Union[str, Unset_Type]" = Unset, reference_value: "Union[str, Unset_Type]" = Unset, reported_mass: "Union[CommonValueWithUnit, Unset_Type]" = Unset,) -> None:
