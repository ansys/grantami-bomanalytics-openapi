...
class GetImpactedSubstancesForSpecificationsResponse(ModelBase):
    ...
    def __init__(self, *, log_messages: "Union[List[CommonLogEntry], Unset_Type]" = Unset, specifications: "Union[List[GetImpactedSubstancesForSpecificationsSpecification], Unset_Type]" = Unset,) -> None:
        ...
        """
        self._specifications: Union[List[GetImpactedSubstancesForSpecificationsSpecification], Unset_Type] = Unset
    ...
    @property
    def specifications(self) -> "Union[List[GetImpactedSubstancesForSpecificationsSpecification], Unset_Type]":
    ...
    def specifications(self, specifications: "Union[List[GetImpactedSubstancesForSpecificationsSpecification], Unset_Type]") -> None:
