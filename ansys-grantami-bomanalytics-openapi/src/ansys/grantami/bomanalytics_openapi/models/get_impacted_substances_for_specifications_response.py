...
class GetImpactedSubstancesForSpecificationsResponse(ModelBase):
    ...
    def __init__(self, *, log_messages: "Optional[List[CommonLogEntry]]" = None, specifications: "Optional[List[GetImpactedSubstancesForSpecificationsSpecification]]" = None) -> None:
    ...
    @property
    def specifications(self) -> "list[GetImpactedSubstancesForSpecificationsSpecification]":
    ...
    def specifications(self, specifications: "list[GetImpactedSubstancesForSpecificationsSpecification]") -> None:
