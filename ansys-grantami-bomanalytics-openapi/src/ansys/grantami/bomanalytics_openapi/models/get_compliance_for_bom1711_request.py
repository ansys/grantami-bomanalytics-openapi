...
class GetComplianceForBom1711Request(ModelBase):
    ...
    def __init__(self, *, bom_xml1711: "Optional[str]" = None, config: "Optional[CommonRequestConfig]" = None, database_key: "Optional[str]" = None, indicators: "Optional[List[CommonIndicatorDefinition]]" = None) -> None:
