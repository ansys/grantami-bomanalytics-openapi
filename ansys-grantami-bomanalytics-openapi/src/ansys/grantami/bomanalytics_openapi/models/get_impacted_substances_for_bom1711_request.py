...
class GetImpactedSubstancesForBom1711Request(ModelBase):
    ...
    def __init__(self, *, bom_xml1711: "Optional[str]" = None, config: "Optional[CommonRequestConfig]" = None, database_key: "Optional[str]" = None, legislation_names: "Optional[List[str]]" = None) -> None:
    ...
    def legislation_names(self) -> "list[str]":
        """Gets the legislation_names of this GetImpactedSubstancesForBom1711Request.

        Returns
        -------
        list[str]
            The legislation_names of this GetImpactedSubstancesForBom1711Request.
        """
