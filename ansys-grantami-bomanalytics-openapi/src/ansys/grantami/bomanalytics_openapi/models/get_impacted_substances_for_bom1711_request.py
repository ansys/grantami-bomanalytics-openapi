...
class GetImpactedSubstancesForBom1711Request(ModelBase):
    ...
    def __init__(self, *, bom_xml1711: "Union[str, Unset_Type]" = Unset, config: "Union[CommonRequestConfig, Unset_Type]" = Unset, database_key: "Union[str, Unset_Type]" = Unset, legislation_ids: "Union[List[str], Unset_Type]" = Unset,) -> None:
