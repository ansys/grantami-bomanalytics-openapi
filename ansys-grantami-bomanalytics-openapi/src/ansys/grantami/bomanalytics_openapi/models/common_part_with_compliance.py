...
class CommonPartWithCompliance(ModelBase):
    ...
    def __init__(self, *, external_identity: "Union[str, Unset_Type]" = Unset, id: "Union[str, Unset_Type]" = Unset, indicators: "Union[List[CommonIndicatorResult], Unset_Type]" = Unset, input_part_number: "Union[str, Unset_Type]" = Unset, materials: "Union[List[CommonMaterialWithCompliance], Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset, parts: "Union[List[CommonPartWithCompliance], Unset_Type]" = Unset, reference_type: "Union[str, Unset_Type]" = Unset, reference_value: "Union[str, Unset_Type]" = Unset, specifications: "Union[List[CommonSpecificationWithCompliance], Unset_Type]" = Unset, substances: "Union[List[CommonSubstanceWithCompliance], Unset_Type]" = Unset,) -> None:
