...
class CommonRequestConfig(ModelBase):
    ...
    def __init__(self, *, coatings_table_name: "Optional[str]" = None, inhouse_materials_table_name: "Optional[str]" = None, material_universe_table_name: "Optional[str]" = None, maximum_spec_to_spec_link_depth: "Optional[int]" = None, products_and_parts_table_name: "Optional[str]" = None, specifications_table_name: "Optional[str]" = None, substances_table_name: "Optional[str]" = None) -> None:
    ...
    def products_and_parts_table_name(self, products_and_parts_table_name: "str") -> None:
    ...
    def maximum_spec_to_spec_link_depth(self, maximum_spec_to_spec_link_depth: "int") -> None:
