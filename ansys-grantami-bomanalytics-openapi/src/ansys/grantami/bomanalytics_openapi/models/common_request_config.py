...
class CommonRequestConfig(ModelBase):
    ...
    def __init__(self, *, coatings_table_name: "Union[str, Unset_Type]" = Unset, inhouse_materials_table_name: "Union[str, Unset_Type]" = Unset, locations_table_name: "Union[str, Unset_Type]" = Unset, material_universe_table_name: "Union[str, Unset_Type]" = Unset, maximum_spec_to_spec_link_depth: "Union[int, Unset_Type]" = Unset, process_universe_table_name: "Union[str, Unset_Type]" = Unset, products_and_parts_table_name: "Union[str, Unset_Type]" = Unset, specifications_table_name: "Union[str, Unset_Type]" = Unset, substances_table_name: "Union[str, Unset_Type]" = Unset, transport_table_name: "Union[str, Unset_Type]" = Unset,) -> None:
    ...
    def material_universe_table_name(self, material_universe_table_name: "Union[str, Unset_Type]") -> None:
    ...
    def inhouse_materials_table_name(self, inhouse_materials_table_name: "Union[str, Unset_Type]") -> None:
    ...
    def specifications_table_name(self, specifications_table_name: "Union[str, Unset_Type]") -> None:
    ...
    def products_and_parts_table_name(self, products_and_parts_table_name: "Union[str, Unset_Type]") -> None:
        ...
        if products_and_parts_table_name is None:
            raise ValueError("Invalid value for 'products_and_parts_table_name', must not be 'None'")
    ...
    def process_universe_table_name(self, process_universe_table_name: "Union[str, Unset_Type]") -> None:
    ...
    def maximum_spec_to_spec_link_depth(self, maximum_spec_to_spec_link_depth: "Union[int, Unset_Type]") -> None:
        ...
        if maximum_spec_to_spec_link_depth is None:
            raise ValueError("Invalid value for 'maximum_spec_to_spec_link_depth', must not be 'None'")
