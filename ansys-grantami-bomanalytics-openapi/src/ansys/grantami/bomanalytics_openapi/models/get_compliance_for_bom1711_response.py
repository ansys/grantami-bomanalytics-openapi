...
class GetComplianceForBom1711Response(ModelBase):
    ...
    def __init__(self, *, log_messages: "Optional[List[CommonLogEntry]]" = None, parts: "Optional[List[CommonPartWithCompliance]]" = None) -> None:
    ...
    def to_dict(self) -> Dict:
        ...
        for attr in self.swagger_types.keys():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetComplianceForBom1711Response, dict):
