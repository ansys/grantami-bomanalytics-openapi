...
class GetComplianceForPartsRequest(ModelBase):
    ...
    def __init__(self, *, config: "Union[CommonRequestConfig, Unset_Type]" = Unset, database_key: "Union[str, Unset_Type]" = Unset, indicators: "Union[List[CommonIndicatorDefinition], Unset_Type]" = Unset, parts: "Union[List[CommonPartReference], Unset_Type]" = Unset,) -> None:
