...
class CommonImpactedSubstance(ModelBase):
    ...
    def __init__(self, *, cas_number: "Optional[str]" = None, ec_number: "Optional[str]" = None, legislation_threshold: "Optional[float]" = None, max_percentage_amount_in_material: "Optional[float]" = None, substance_name: "Optional[str]" = None) -> None:
    ...
    def max_percentage_amount_in_material(self, max_percentage_amount_in_material: "float") -> None:
