...
class CommonImpactedSubstance(ModelBase):
    ...
    def __init__(self, *, cas_number: "Union[str, Unset_Type]" = Unset, ec_number: "Union[str, Unset_Type]" = Unset, legislation_threshold: "Union[float, None, Unset_Type]" = Unset, max_percentage_amount_in_material: "Union[float, None, Unset_Type]" = Unset, substance_name: "Union[str, Unset_Type]" = Unset,) -> None:
    ...
    def max_percentage_amount_in_material(self, max_percentage_amount_in_material: "Union[float, None, Unset_Type]") -> None:
    ...
    def legislation_threshold(self, legislation_threshold: "Union[float, None, Unset_Type]") -> None:
