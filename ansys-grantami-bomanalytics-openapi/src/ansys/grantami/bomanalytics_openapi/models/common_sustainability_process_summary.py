...
class CommonSustainabilityProcessSummary(ModelBase):
    ...
    def __init__(self, *, joining_and_finishing_processes: "Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type]" = Unset, phase_summary: "Union[CommonSustainabilityPhaseSummary, Unset_Type]" = Unset, primary_processes: "Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type]" = Unset, secondary_processes: "Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type]" = Unset,) -> None:
        ...
        """
        self._primary_processes: Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type] = Unset
        self._secondary_processes: Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type] = Unset
        self._joining_and_finishing_processes: Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type] = Unset
    ...
    @property
    def primary_processes(self) -> "Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type]":
    ...
    def primary_processes(self, primary_processes: "Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type]") -> None:
    ...
    @property
    def secondary_processes(self) -> "Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type]":
    ...
    def secondary_processes(self, secondary_processes: "Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type]") -> None:
    ...
    @property
    def joining_and_finishing_processes(self) -> "Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type]":
    ...
    def joining_and_finishing_processes(self, joining_and_finishing_processes: "Union[List[CommonSustainabilityProcessSummaryEntry], Unset_Type]") -> None:
        ...
        if joining_and_finishing_processes is None:
            raise ValueError("Invalid value for 'joining_and_finishing_processes', must not be 'None'")
