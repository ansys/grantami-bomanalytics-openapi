...
class GetImpactedSubstancesForMaterialsResponse(ModelBase):
    ...
    def __init__(self, *, log_messages: "Union[List[CommonLogEntry], Unset_Type]" = Unset, materials: "Union[List[GetImpactedSubstancesForMaterialsMaterial], Unset_Type]" = Unset,) -> None:
    ...
    @materials.setter
    def materials(self, materials: "Union[List[GetImpactedSubstancesForMaterialsMaterial], Unset_Type]") -> None:
