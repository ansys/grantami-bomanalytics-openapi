...
class GetImpactedSubstancesForMaterialsResponse(ModelBase):
    ...
    def __init__(self, *, log_messages: "Optional[List[CommonLogEntry]]" = None, materials: "Optional[List[GetImpactedSubstancesForMaterialsMaterial]]" = None) -> None:
    ...
    @materials.setter
    def materials(self, materials: "list[GetImpactedSubstancesForMaterialsMaterial]") -> None:
