...
class CommonSustainabilityPhaseSummary(ModelBase):
    ...
    def __init__(self, *, climate_change: "Union[CommonValueWithUnit, Unset_Type]" = Unset, climate_change_percentage: "Union[float, Unset_Type]" = Unset, embodied_energy: "Union[CommonValueWithUnit, Unset_Type]" = Unset, embodied_energy_percentage: "Union[float, Unset_Type]" = Unset, phase: "Union[str, Unset_Type]" = Unset,) -> None:
