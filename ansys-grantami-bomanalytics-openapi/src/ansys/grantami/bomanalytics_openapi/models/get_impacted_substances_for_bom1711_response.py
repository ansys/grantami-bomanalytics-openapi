...
class GetImpactedSubstancesForBom1711Response(ModelBase):
    ...
    def __init__(self, *, legislations: "Union[List[CommonLegislationWithImpactedSubstances], Unset_Type]" = Unset, log_messages: "Union[List[CommonLogEntry], Unset_Type]" = Unset,) -> None:
