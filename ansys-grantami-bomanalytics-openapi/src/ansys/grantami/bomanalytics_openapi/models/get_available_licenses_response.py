...
class GetAvailableLicensesResponse(ModelBase):
    ...
    def __init__(self, *, log_messages: "Union[List[CommonLogEntry], Unset_Type]" = Unset, restricted_substances: "Union[bool, Unset_Type]" = Unset, sustainability: "Union[bool, Unset_Type]" = Unset,) -> None:
