...
class CommonSustainabilityMaterialSummary(ModelBase):
    ...
    def __init__(self, *, phase_summary: "Union[CommonSustainabilityPhaseSummary, Unset_Type]" = Unset, summary: "Union[List[CommonSustainabilityMaterialSummaryEntry], Unset_Type]" = Unset,) -> None:
    ...
    @summary.setter
    def summary(self, summary: "Union[List[CommonSustainabilityMaterialSummaryEntry], Unset_Type]") -> None:
