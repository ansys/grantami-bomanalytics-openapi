...
class GetImpactedSubstancesForSpecificationsRequest(ModelBase):
    ...
    def __init__(self, *, config: "Optional[CommonRequestConfig]" = None, database_key: "Optional[str]" = None, legislation_names: "Optional[List[str]]" = None, specifications: "Optional[List[CommonSpecificationReference]]" = None) -> None:
    ...
    def specifications(self, specifications: "list[CommonSpecificationReference]") -> None:
    ...
    def legislation_names(self) -> "list[str]":
        """Gets the legislation_names of this GetImpactedSubstancesForSpecificationsRequest.

        Returns
        -------
        list[str]
            The legislation_names of this GetImpactedSubstancesForSpecificationsRequest.
        """
