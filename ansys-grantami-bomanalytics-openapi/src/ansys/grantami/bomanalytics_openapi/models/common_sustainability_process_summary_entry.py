...
class CommonSustainabilityProcessSummaryEntry(ModelBase):
    ...
    def __init__(self, *, climate_change: "Union[CommonValueWithUnit, Unset_Type]" = Unset, climate_change_percentage: "Union[float, Unset_Type]" = Unset, embodied_energy: "Union[CommonValueWithUnit, Unset_Type]" = Unset, embodied_energy_percentage: "Union[float, Unset_Type]" = Unset, material_identity: "Union[str, Unset_Type]" = Unset, material_record_reference: "Union[CommonMaterialReference, Unset_Type]" = Unset, process_name: "Union[str, Unset_Type]" = Unset, process_record_reference: "Union[CommonProcessReference, Unset_Type]" = Unset,) -> None:
    ...
    def process_record_reference(self, process_record_reference: "Union[CommonProcessReference, Unset_Type]") -> None:
    ...
    def material_record_reference(self, material_record_reference: "Union[CommonMaterialReference, Unset_Type]") -> None:
