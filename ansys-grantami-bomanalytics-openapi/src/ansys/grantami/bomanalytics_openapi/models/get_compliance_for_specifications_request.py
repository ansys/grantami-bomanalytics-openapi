...
class GetComplianceForSpecificationsRequest(ModelBase):
    ...
    def __init__(self, *, config: "Union[CommonRequestConfig, Unset_Type]" = Unset, database_key: "Union[str, Unset_Type]" = Unset, indicators: "Union[List[CommonIndicatorDefinition], Unset_Type]" = Unset, specifications: "Union[List[CommonSpecificationReference], Unset_Type]" = Unset,) -> None:
    ...
    def specifications(self, specifications: "Union[List[CommonSpecificationReference], Unset_Type]") -> None:
