...
class GetComplianceForSpecificationsRequest(ModelBase):
    ...
    def __init__(self, *, config: "Optional[CommonRequestConfig]" = None, database_key: "Optional[str]" = None, indicators: "Optional[List[CommonIndicatorDefinition]]" = None, specifications: "Optional[List[CommonSpecificationReference]]" = None) -> None:
