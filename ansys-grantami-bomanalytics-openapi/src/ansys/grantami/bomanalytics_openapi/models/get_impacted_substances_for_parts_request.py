...
class GetImpactedSubstancesForPartsRequest(ModelBase):
    ...
    def __init__(self, *, config: "Optional[CommonRequestConfig]" = None, database_key: "Optional[str]" = None, legislation_names: "Optional[List[str]]" = None, parts: "Optional[List[CommonPartReference]]" = None) -> None:
