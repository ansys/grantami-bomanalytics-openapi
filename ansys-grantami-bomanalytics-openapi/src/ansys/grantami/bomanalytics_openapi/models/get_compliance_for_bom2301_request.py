...
class GetComplianceForBom2301Request(ModelBase):
    ...
    def __init__(self, *, bom_xml2301: "Union[str, Unset_Type]" = Unset, config: "Union[CommonRequestConfig, Unset_Type]" = Unset, database_key: "Union[str, Unset_Type]" = Unset, indicators: "Union[List[CommonIndicatorDefinition], Unset_Type]" = Unset,) -> None:
