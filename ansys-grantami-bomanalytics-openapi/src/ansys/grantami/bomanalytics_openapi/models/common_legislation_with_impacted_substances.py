...
class CommonLegislationWithImpactedSubstances(ModelBase):
    ...
    def __init__(self, *, impacted_substances: "Optional[List[CommonImpactedSubstance]]" = None, legislation_name: "Optional[str]" = None) -> None:
    ...
    def impacted_substances(self, impacted_substances: "list[CommonImpactedSubstance]") -> None:
