...
class CommonLegislationWithImpactedSubstances(ModelBase):
    ...
    def __init__(self, *, impacted_substances: "Union[List[CommonImpactedSubstance], Unset_Type]" = Unset, legislation_id: "Union[str, Unset_Type]" = Unset,) -> None:
    ...
    def impacted_substances(self, impacted_substances: "Union[List[CommonImpactedSubstance], Unset_Type]") -> None:
