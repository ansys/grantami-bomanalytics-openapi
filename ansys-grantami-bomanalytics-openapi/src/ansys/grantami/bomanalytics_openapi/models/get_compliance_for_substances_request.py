...
class GetComplianceForSubstancesRequest(ModelBase):
    ...
    def __init__(self, *, config: "Union[CommonRequestConfig, Unset_Type]" = Unset, database_key: "Union[str, Unset_Type]" = Unset, indicators: "Union[List[CommonIndicatorDefinition], Unset_Type]" = Unset, substances: "Union[List[GetComplianceForSubstancesSubstanceWithAmount], Unset_Type]" = Unset,) -> None:
        ...
        """
        self._substances: Union[List[GetComplianceForSubstancesSubstanceWithAmount], Unset_Type] = Unset
    ...
    @property
    def substances(self) -> "Union[List[GetComplianceForSubstancesSubstanceWithAmount], Unset_Type]":
    ...
    @substances.setter
    def substances(self, substances: "Union[List[GetComplianceForSubstancesSubstanceWithAmount], Unset_Type]") -> None:
