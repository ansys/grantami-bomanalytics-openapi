...
class GetComplianceForSubstancesRequest(ModelBase):
    ...
    def __init__(self, *, config: "Optional[CommonRequestConfig]" = None, database_key: "Optional[str]" = None, indicators: "Optional[List[CommonIndicatorDefinition]]" = None, substances: "Optional[List[GetComplianceForSubstancesSubstanceWithAmount]]" = None) -> None:
    ...
    @substances.setter
    def substances(self, substances: "list[GetComplianceForSubstancesSubstanceWithAmount]") -> None:
