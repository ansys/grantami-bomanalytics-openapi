...
class GetImpactedSubstancesForMaterialsMaterial(ModelBase):
    ...
    def __init__(self, *, external_identity: "Union[str, Unset_Type]" = Unset, id: "Union[str, Unset_Type]" = Unset, legislations: "Union[List[CommonLegislationWithImpactedSubstances], Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset, reference_type: "Union[str, Unset_Type]" = Unset, reference_value: "Union[str, Unset_Type]" = Unset,) -> None:
    ...
    @legislations.setter
    def legislations(self, legislations: "Union[List[CommonLegislationWithImpactedSubstances], Unset_Type]") -> None:
