...
class GetSustainabilitySummaryForBom2301Request(ModelBase):
    ...
    def __init__(self, *, bom_xml2301: "Union[str, Unset_Type]" = Unset, config: "Union[CommonRequestConfig, Unset_Type]" = Unset, database_key: "Union[str, Unset_Type]" = Unset, preferred_units: "Union[CommonPreferredUnits, Unset_Type]" = Unset,) -> None:
