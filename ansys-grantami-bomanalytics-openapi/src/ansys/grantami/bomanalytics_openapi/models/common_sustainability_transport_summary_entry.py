...
class CommonSustainabilityTransportSummaryEntry(ModelBase):
    ...
    def __init__(self, *, climate_change: "Union[CommonValueWithUnit, Unset_Type]" = Unset, climate_change_percentage: "Union[float, Unset_Type]" = Unset, distance: "Union[CommonValueWithUnit, Unset_Type]" = Unset, embodied_energy: "Union[CommonValueWithUnit, Unset_Type]" = Unset, embodied_energy_percentage: "Union[float, Unset_Type]" = Unset, record_reference: "Union[CommonTransportReference, Unset_Type]" = Unset, stage_name: "Union[str, Unset_Type]" = Unset,) -> None:
    ...
    def record_reference(self, record_reference: "Union[CommonTransportReference, Unset_Type]") -> None:
