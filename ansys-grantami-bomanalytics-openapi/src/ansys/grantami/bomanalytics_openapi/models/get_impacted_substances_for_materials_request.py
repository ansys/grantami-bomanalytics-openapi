...
class GetImpactedSubstancesForMaterialsRequest(ModelBase):
    ...
    def __init__(self, *, config: "Union[CommonRequestConfig, Unset_Type]" = Unset, database_key: "Union[str, Unset_Type]" = Unset, legislation_ids: "Union[List[str], Unset_Type]" = Unset, materials: "Union[List[CommonMaterialReference], Unset_Type]" = Unset,) -> None:
