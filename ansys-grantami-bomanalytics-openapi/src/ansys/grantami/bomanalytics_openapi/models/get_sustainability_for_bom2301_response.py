...
class GetSustainabilityForBom2301Response(ModelBase):
    ...
    def __init__(self, *, log_messages: "Union[List[CommonLogEntry], Unset_Type]" = Unset, parts: "Union[List[CommonSustainabilityPartWithSustainability], Unset_Type]" = Unset, transport_stages: "Union[List[CommonSustainabilityTransportWithSustainability], Unset_Type]" = Unset,) -> None:
        ...
        self._transport_stages: Union[List[CommonSustainabilityTransportWithSustainability], Unset_Type] = Unset
    ...
    @property
    def transport_stages(self) -> "Union[List[CommonSustainabilityTransportWithSustainability], Unset_Type]":
    ...
    def transport_stages(self, transport_stages: "Union[List[CommonSustainabilityTransportWithSustainability], Unset_Type]") -> None:
