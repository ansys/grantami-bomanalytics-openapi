...
class CommonCoatingWithCompliance(ModelBase):
    ...
    def __init__(self, *, id: "Union[str, Unset_Type]" = Unset, indicators: "Union[List[CommonIndicatorResult], Unset_Type]" = Unset, reference_type: "Union[str, Unset_Type]" = Unset, reference_value: "Union[str, Unset_Type]" = Unset, substances: "Union[List[CommonSubstanceWithCompliance], Unset_Type]" = Unset,) -> None:
