...
class CommonCoatingWithCompliance(ModelBase):
    ...
    def __init__(self, *, indicators: "Optional[List[CommonIndicatorResult]]" = None, reference_type: "Optional[str]" = None, reference_value: "Optional[str]" = None, substances: "Optional[List[CommonSubstanceWithCompliance]]" = None) -> None:
